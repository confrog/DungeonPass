...
function camp.Merchant:visit_merchant(player)
  ...
  return camp.Merchant:at_merchant(player)
end
function camp.Merchant:at_merchant(player)
  return choices.choose(
    ...
    choices.options(
      "Buy",
      function()
        return camp.Merchant:buy(player)
      end,
      "Sell",
      function()
        return camp.Merchant:sell(player)
      end,
      "Talk to the merchant",
      function()
        return camp.Merchant:dialogue(player)
      end,
...
function camp.Merchant:dialogue(player)
  return choices.choose(
    ...
    choices.options(
      ...
      'Back',
      function()
        return self:at_merchant(player)
      end))
end       
-- Fountain --
camp.Fountain = {}
function camp.Fountain:visit_fountain(player)
  ...
  return camp.Fountain:at_fountain(player)
end
...
function camp.Camp:enter_camp(player)
  ...
  if player.location == "001" then
    ui:message("You walk back to the center of camp.\n")
  else
    player.location = "001"
...
function camp.Camp:in_camp (player)
  return choices.choose(
    ...
    choices.options(
      ...
      function()
        return camp.Merchant:visit_merchant(player)
      end,
      "Go West - Visit the fountain",
      function()
        return camp.Fountain:visit_fountain(player)
      end,
      ...
      function()
        ...
        if player.equipped.trinket.name == "none" then
        ...
        return choices.choose(
          ...
          choices.options(
            "Equip item",
            function()
              return camp.Camp:equipping_item(player)
            end,
            "View abilities",
            function()
    ...
    for k,v in ipairs(player.inventory) do
      ...
      if v.equipped == true then
        ...
        ui:message("(E) "..k.." > "..v.name.."\tvalue: "..v.value.." coins\tdefense: "..v.defense)
          ...
          ui:message("(E) "..k.." > "..v.name.."\tvalue: "..v.value.." coins\tattack: "..v.atk.."\tdamage: "..v.dmg.."\tdefense: "..v.defense)
        end
      elseif v.item_type == "weapon" then
        ui:message(k.." > "..v.name.."\tvalue: "..v.value.." coins\tattack: "..v.atk.."\tdamage: "..v.dmg)
      elseif v.item_type == "armor" then
...
function camp.Camp:load_tile(player)
  ...
  return camp.Camp:in_camp(player)
end
--
return camp